/* megafunction wizard: %ARM-Based Excalibur%
   ...
   PROJECT: hello
   ============================================================
   File Name: E:\Arthur\sample\gnu\stripe.h
...
#define EXC_AHB1_CLK_FREQUENCY (162500000)
#define EXC_AHB2_CLK_FREQUENCY (81250000)
...
/* SDRAM Block(s) */
#define EXC_SDRAM_BLOCK0_BASE (0x10000000)
